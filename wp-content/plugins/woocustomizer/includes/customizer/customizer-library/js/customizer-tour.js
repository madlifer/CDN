...
( function( $ ) {
    $( document ).ready( function () {
        ...
        $( '#sub-accordion-panel-wcz-panel-settings' ).append( `<div class="wcz-tour-wrap"><a href="${wcz_tour.texts.premium_link}" target="_blank">${wcz_tour.texts.premium_set}</a><div class="wcz-tour-btn">${wcz_tour.texts.show}</div><a href="https://woocustomizer.com/#anchor-contact" target="_blank">${wcz_tour.texts.contact}</a></div>` );
