...
<?php
	...
	if( isset( $_GET[ 'rtwwwap_tab' ] ) )
	{
		...
		elseif( $_GET[ 'rtwwwap_tab' ] == "rtwwwap_addons" || $_GET[ 'rtwwwap_tab' ] == "rtwwwap_sms" || $_GET[ 'rtwwwap_tab' ] == "rtwwwap_register_template" )
		{
...
<div class="wrap rtwwwap">
	...
	<?php
		if( isset( $_GET[ 'rtwwwap_tab' ] ) )
		{
			...
			elseif( $_GET[ 'rtwwwap_tab' ] == "rtwwwap_commission" || $_GET[ 'rtwwwap_tab' ] == "rtwwwap_extra" || $_GET[ 'rtwwwap_tab' ] == "rtwwwap_levels_add_edit" || $_GET[ 'rtwwwap_tab' ] == "rtwwwap_mlm" || $_GET[ 'rtwwwap_tab' ] == "rtwwwap_register_template" )
			{
	?>
