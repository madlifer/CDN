			...
			<div class="box-column" id="rtwwwap_total_comm">
				<div class="box-content">
					...
					<div class="box-content-desc">
						...
						<div class="box-content-right">
						<?php printf( '<span class="box-content-value">%s%01.'.$rtwwwap_decimal_places.'</span>', esc_html( $rtwwwap_currency_sym ), ( $rtwwwap_total_comm ) ? esc_html( $rtwwwap_total_comm ) : esc_html( '0' ) ); ?>
			...
			<div class="box-column" id="rtwwwap_approved_comm">
				<div class="box-content">
					...
					<div class="box-content-desc">
						...
						<div class="box-content-right">
						<?php printf( '<span class="box-content-value">%s%01.'.$rtwwwap_decimal_places.'</span>', esc_html( $rtwwwap_currency_sym ), ( $rtwwwap_approved_comm ) ? esc_html( $rtwwwap_approved_comm ) : esc_html( '0' ) ); ?>
			...
			<div class="box-column" id="rtwwwap_pending_comm">
				<div class="box-content">
					...
					<div class="box-content-desc">
						...
						<div class="box-content-right">
						<?php printf( '<span class="box-content-value">%s%01.'.$rtwwwap_decimal_places.'</span>', esc_html( $rtwwwap_currency_sym ), ( $rtwwwap_pending_comm ) ? esc_html( $rtwwwap_pending_comm ) : esc_html( '0' ) ); ?>
				...
				<ul>
					...
					?>
								<li>
									...
									?>
									<?php printf( '%s%01.'.$rtwwwap_decimal_places.' %s %s %s %s', esc_html( $rtwwwap_currency_sym ), esc_html( $rtwwwap_value[ 'amount' ] ), esc_html__( 'for', 'rtwwwap-wp-wc-affiliate-program' ), esc_html( $rtwwwap_aff_name ), esc_html__( 'on', 'rtwwwap-wp-wc-affiliate-program' ), esc_html( $rtwwwap_local_date ) ); ?>
								</li>
					<?php
							}
						}
				...
				<ol>
					...
					?>
								<li>
									...
									<p><?php printf( '%s %u | %s %s%01.'.$rtwwwap_decimal_places, esc_html__( 'Referrals', 'rtwwwap-wp-wc-affiliate-program' ), esc_html( $rtwwwap_value1[ 'count' ] ), esc_html__( 'Total Amount', 'rtwwwap-wp-wc-affiliate-program' ), esc_html( $rtwwwap_currency_sym ), esc_html( $rtwwwap_value1[ 'amount' ] ) ); ?></p>
								</li>
					<?php
							}
						}
