						...
						foreach ($rtwwwap_reg_custom_fields as $count => $custom_fields) {
							...
							<div class="rtwwwap-input_type-inner-wrapper<?php echo esc_attr($counter,  'rtwwwap-wp-wc-affiliate-program'); ?> rtwwwap-input_type-inner">
								...
								<span class="rtwwwap-custom-type-span">
									...
									<input type="text" name="rtwwwap_reg_temp_opt[custom-input][<?php echo esc_attr($count,  'rtwwwap-wp-wc-affiliate-program'); ?>][custom-input-class]" class="rtwwwap-custom-type-class" value="<?php echo  esc_attr($custom_fields['custom-input-class'],  'rtwwwap-wp-wc-affiliate-program'); ?>">
								</span>
								
								<span class="rtwwwap-custom-type-span">
									<label for="rtwwwap-custom-type-id"><?php esc_html_e( 'Id', 'rtwwwap-wp-wc-affiliate-program' ); ?></label>
									<input type="text" name="rtwwwap_reg_temp_opt[custom-input][<?php echo  esc_attr($count,  'rtwwwap-wp-wc-affiliate-program'); ?>][custom-input-id]" class="rtwwwap-custom-type-id" value="<?php echo  esc_attr($custom_fields['custom-input-id'],'rtwwwap-wp-wc-affiliate-program'); ?>">
								</span>
