...
if( !isset( $_GET[ 'rtwwwap_tab' ] ) || ( isset( $_GET[ 'rtwwwap_tab' ] ) && $_GET[ 'rtwwwap_tab' ] == 'overview' ) ){
	...
	$rtwwwap_html1 .= 			sprintf( '%s', esc_html__( 'Request for Withdraw', 'rtwwwap-wp-wc-affiliate-program' ) );
	$rtwwwap_html1 .= 		'</p>';
	$rtwwwap_html1 .= 	'</div>';
	$rtwwwap_html1 .= 	'<div class="rtwwwap_request_withdraw">';
	$rtwwwap_html1 .= 	'<div class="rtwwwap_request_texraea">';
	$rtwwwap_html1 .= 		'<textarea rows="3" class="rtwwwap_request_msg" placeholder="'.esc_html__( "Enter Your Message for Withdrawal of Commission to Admin", "rtwwwap-wp-wc-affiliate-program" ).'" ></textarea>';
	$rtwwwap_html1 .= 	'</div>';
	$rtwwwap_html1 .= 	'<div class="rtwwwap_request_button-wrap">';
	$rtwwwap_html1 .= 		'<button name="rtwwwap_rqst_mail" id="rtwwwap_rqst_mail">'.esc_html__( "Send mail", "rtwwwap-wp-wc-affiliate-program" ).'</button>';
	$rtwwwap_html1 .= 	'</div>';
	$rtwwwap_html1 .= 	'</div>';
	$rtwwwap_html1 .= 	'<div>';
	$rtwwwap_html1 .= 		'<p class="rtwwwap_rqst_mail_sent rtwwwap_rqst_msg_hidden">'.esc_html__( "Mail Sent Successfully", "rtwwwap-wp-wc-affiliate-program" ).'</p>';
	$rtwwwap_html1 .= 	'</div>';
		//request commission
		...
		if( $rtwwwap_comm_base == 1 ){
			...
			if( !empty( $rtwwwap_levels_settings ) )
			{
				...
				foreach( $rtwwwap_levels_settings as $rtwwwap_levels_key => $rtwwwap_levels_val )
				{
					...
					{
						$rtwwwap_html1 .= sprintf( '%s %s%01.'.$rtwwwap_decimal_places, esc_html__( 'Total sale amount' ), $rtwwwap_currency_sym, esc_html__( $rtwwwap_levels_val[ 'level_criteria_val' ] ) );
						;
					}
					$rtwwwap_html1 .= 			'</td>';
					$rtwwwap_html1 .= 		'</tr>';
...
if( isset( $_GET[ 'rtwwwap_tab' ] ) && $_GET[ 'rtwwwap_tab' ] == 'affiliate_tools' ){
	...
	$rtwwwap_html1 .=	    	'<input type="button" id="rtwwwap_generate_button" data-rtwwwap_aff_id="'.esc_attr( get_current_user_id() ).'" data-rtwwwap_aff_name="'.esc_attr( $rtwwwap_user_name ).'" value="'.esc_attr__( 'Generate link', 'rtwwwap-wp-wc-affiliate-program' ).'" />';
...
if( isset( $_GET[ 'rtwwwap_tab' ] ) && $_GET[ 'rtwwwap_tab' ] == 'profile' ){
	...
	$rtwwwap_html1 .= 		'</div">';
	$rtwwwap_html1 .= 		'<div><input type="submit" class="rtwwwap_profile_save" value="'.esc_attr__( "Update Details", "rtwwwap-wp-wc-affiliate-program" ).'" id="rtwwwap_profile_save" name="rtwwwap_profile_save"></div>';
	$rtwwwap_html1 .= 	'</form">';
	return $rtwwwap_html1;
}
...
if( isset( $rtwwwap_mlm[ 'activate' ] ) && $rtwwwap_mlm[ 'activate' ] == 1 )
{
	if( isset( $_GET[ 'rtwwwap_tab' ] ) && $_GET[ 'rtwwwap_tab' ] == 'mlm' )
	{
		...
		$rtwwwap_html1 .= 			'<tr>';
		$rtwwwap_html1 .= 				'<th colspan="3">';
		$rtwwwap_html1 .= 		 			esc_html__( 'MLM Levels' );
		$rtwwwap_html1 .= 				'</th>';
		$rtwwwap_html1 .= 			'</tr>';
		$rtwwwap_html1 .= 		'</thead>';
